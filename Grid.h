...
public:
	...
	bool GetCrowded(int, int, int);

	bool GetCrowdedOfSnake(int,int);
	bool GetCrowdedOfLadder(int,int);
	int GetCardNumInCell(int, int) const;
	bool CellHasCard(int, int) const;
	Player* GetPlayerFromNum(int);

	void SetCrowdedOfSnake(int,int,int,bool);
	void SetCrowdedOfLadder(int,int,int,bool);

	void SetHasSnakeHead(int, int, bool);
	void SetHasSnakeEnd(int, int, bool);
	void SetHasLadderEnd(int, int, bool);

	bool GetHasObj(int, int);

	void SetNotCrowded(int, int, int);
	...
	int * GetNextPlayer(const CellPosition& position,int&);    // Gets a pointer to the first player after the passed "position"


	Ladder * GetLadderObject(CellPosition);

	Snake * GetSnakeObject(CellPosition);
