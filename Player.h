...
class Player
{
	...
	bool Card4Penalty;
	bool Card4PenaltyCounter;

	bool Imprisoned;
	int ImprisonedCounter;
...
public:
	...
	void SetCard4Penalty(bool);
	void SetWallet(int wallet);		// A setter for the wallet
	void SetImprisoned(bool);       // A setter for imprisoned
	...
	bool GetImprisoned() const;
	int GetImprisonedCounter() const;
